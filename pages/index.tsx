  ...
  return (
    <div className="min-h-screen min-w-screen">
      ...
      <main className="flex h-[200%] flex-1 flex-col justify-start px-4 xl:px-16 bg-gradient-to-br from-orange-500 to-fuchsia-400 tracking-wide text-white text-center md:text-left ">
        ...
        <div className="font-fancy px-12 pt-12 mx-[5%] my-12 bg-white rounded-lg text-black flex flex-col xl:flex-row justify-between">
          <div>
            <h2 className="text-transparent text-4xl xl:text-5xl xl:w-1/3 bg-clip-text bg-gradient-to-r from-fuchsia-400 to-orange-500">About Me</h2>
            <p className="font-mono pt-4 pb-12 xl:w-3/4 text-lg">I’m Erin Murphy, a senior at Florida State University studying Computer Engineering.
              Outside of class, I’m an athlete on FSU’s D1 NCAA Beach Volleyball team. I also conduct research about computer vision and synthetic 
              data under Dr. Jonathan Adams and our newly founded research center the MLab!
              <br/><br/>Feel free to reach out with any questions 😊
            </p>
          </div>
          <img src="erin.jpg" alt="Erin Murphy" width="250px" className="xl:mr-[8%]"/>
        </div>
        <div className="font-fancy px-12 pt-12 mx-[5%] xl:my-12 bg-white rounded-lg text-black">
          <h2 className="text-transparent text-4xl xl:text-5xl xl:w-1/3 bg-clip-text bg-gradient-to-r from-purple-400 to-fuchsia-500">Projects</h2>
          <p className="font-mono pt-4 xl:w-3/4 text-lg">List of project info here<br /><br /><br /><br /><br /><br /><br /><br /><br />
          </p> 
        </div>    
      </main>
    </div>
